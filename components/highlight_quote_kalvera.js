        ...
        <section className="w-full xl:px-0 md:px-12 px-6 xl:py-24 py-12">
            <div className="flex flex-row justify-center items-center max-w-7xl mx-auto">
                ...
                <span className="lg:text-3xl text-2xl">
                        &quot;Ideonic Labs&apos;s comprehensive user experience audit uncovered significant issues that impacted our prospective customers trying to book our services online. An incredible discovery that increased our online bookings by 15%!&quot;
                    </span>
